...
from core.operations import TurningOp, MillingOp, DrillingG1Op
from core.specific_calc import (
    TurningCalculator, MillingCalculator, DrillingG1Calculator
)
...
class BackSpindleFrame(ctk.CTkFrame):
    ...
    def _setup_ui(self) -> None:
        ...
        ctk.CTkLabel(self.input_container, text="Add Back Spindle Operation", font=("Arial", 16, "bold")).pack(pady=10)
        ...
        self.op_selector = ctk.CTkOptionMenu(
            ...
            values=["Turning", "Milling", "Drilling (G1)"],
    ...
    def _add_operation(self) -> None:
        """Calculates and adds to session."""
